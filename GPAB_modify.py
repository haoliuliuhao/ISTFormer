...
if __name__ == '__main__':
    ...
    model = PSA_Block(dim=c, input_resolution=(h, w), num_heads=2, window_size=8)
    oup = model(inp, (h, w))
    print(oup.shape)    # torch.Size([1, 3, 240, 240])
    
    # inp = torch.rand((1, 48576, 60))        # [1, 60, 264, 184]
    # rev = inp.reshape(b, h, w, c).permute(0, 3, 1, 2)
    # print(rev.shape)
